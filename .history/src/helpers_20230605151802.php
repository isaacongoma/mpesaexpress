...
if (!function_exists("mpesa_setup_stk")) {
    ...
    {
        return Ongoma\UnityPayment\LipaNaMpesa\STK::init($config);
    }
}
...
if (!function_exists("mpesa_setup_c2b")) {
    ...
    {
        return Ongoma\UnityPayment\LipaNaMpesa\C2B::init($config);
    }
}
...
if (!function_exists("mpesa_setup_b2c")) {
    ...
    {
        return Ongoma\UnityPayment\LipaNaMpesa\B2C::init($config);
    }
}
...
if (!function_exists("mpesa_setup_b2b")) {
    ...
    {
        return Ongoma\UnityPayment\LipaNaMpesa\B2B::init($config);
    }
}
...
if (!function_exists("mpesa_stk_push")) {
    ...
    {
        return Ongoma\UnityPayment\LipaNaMpesa\C2B::stk($phone, $amount, $reference);
    }
}
...
if (!function_exists("mpesa_c2b_request")) {
    ...
    {
        return Ongoma\UnityPayment\LipaNaMpesa\C2B::simulate($phone, $amount, $reference);
    }
}
...
if (!function_exists("mpesa_b2c_request")) {
    ...
    {
        return Ongoma\UnityPayment\LipaNaMpesa\B2C::send($phone, $amount, $reference);
    }
}
...
if (!function_exists("mpesa_b2b_request")) {
    ...
    {
        return Ongoma\UnityPayment\LipaNaMpesa\B2B::send($phone, $amount, $reference);
    }
}
...
if (!function_exists("mpesa_validate")) {
    ...
    {
        return Ongoma\UnityPayment\LipaNaMpesa\Service::validate($callback);
    }
}
...
if (!function_exists("mpesa_confirm")) {
    ...
    {
        return Ongoma\UnityPayment\LipaNaMpesa\Service::confirm($callback);
    }
}
...
if (!function_exists("mpesa_reconcile")) {
    ...
    {
        return Ongoma\UnityPayment\LipaNaMpesa\Service::reconcile($callback);
    }
}
...
if (!function_exists("mpesa_results")) {
    ...
    {
        return Ongoma\UnityPayment\LipaNaMpesa\Service::results($callback);
    }
}
...
if (!function_exists("mpesa_timeout")) {
    ...
    {
        return Ongoma\UnityPayment\LipaNaMpesa\Service::timeout();
    }
}
