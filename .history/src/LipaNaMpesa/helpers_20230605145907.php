...
if (!function_exists("mpesa_setup_stk")) {
    ...
    {
        return Ongoma\LipaNaMpesa\Mpesa\STK::init($config);
    }
}
...
if (!function_exists("mpesa_setup_c2b")) {
    ...
    {
        return Ongoma\LipaNaMpesa\Mpesa\C2B::init($config);
    }
}
...
if (!function_exists("mpesa_setup_b2c")) {
    ...
    {
        return Ongoma\LipaNaMpesa\Mpesa\B2C::init($config);
    }
}
...
if (!function_exists("mpesa_setup_b2b")) {
    ...
    {
        return Ongoma\LipaNaMpesa\Mpesa\B2B::init($config);
    }
}
...
if (!function_exists("mpesa_stk_push")) {
    ...
    {
        return Ongoma\LipaNaMpesa\Mpesa\C2B::stk($phone, $amount, $reference);
    }
}
...
if (!function_exists("mpesa_c2b_request")) {
    ...
    {
        return Ongoma\LipaNaMpesa\Mpesa\C2B::simulate($phone, $amount, $reference);
    }
}
...
if (!function_exists("mpesa_b2c_request")) {
    ...
    {
        return Ongoma\LipaNaMpesa\Mpesa\B2C::send($phone, $amount, $reference);
    }
}
...
if (!function_exists("mpesa_b2b_request")) {
    ...
    {
        return Ongoma\LipaNaMpesa\Mpesa\B2B::send($phone, $amount, $reference);
    }
}
...
if (!function_exists("mpesa_validate")) {
    ...
    {
        return Ongoma\LipaNaMpesa\Mpesa\Service::validate($callback);
    }
}
...
if (!function_exists("mpesa_confirm")) {
    ...
    {
        return Ongoma\LipaNaMpesa\Mpesa\Service::confirm($callback);
    }
}
...
if (!function_exists("mpesa_reconcile")) {
    ...
    {
        return Ongoma\LipaNaMpesa\Mpesa\Service::reconcile($callback);
    }
}
...
if (!function_exists("mpesa_results")) {
    ...
    {
        return Ongoma\LipaNaMpesa\Mpesa\Service::results($callback);
    }
}
...
if (!function_exists("mpesa_timeout")) {
    ...
    {
        return Ongoma\LipaNaMpesa\Mpesa\Service::timeout();
    }
}
